use sex::{AtomTy, FromSex, SexError, parse_expression_str};
...
fn struct_positional() {
    ...
    let p: Point = Point::from_atom(&atom).unwrap();
...
fn struct_positional_single() {
    ...
    let err = Point::from_atom(&atom).unwrap_err();
...
fn struct_keyword() {
    ...
    let c: Config = Config::from_atom(&atom).unwrap();
...
fn struct_keyword_missing_optional() {
    ...
    let err = Config::from_atom(&atom).unwrap_err();
...
fn struct_optional_keyword_present() {
    ...
    let o: OptionalFields = OptionalFields::from_atom(&atom).unwrap();
...
fn enum_tuple_primitive() {
    ...
    let s: Shape = Shape::from_atom(&atom).unwrap();
...
fn enum_unit_variant() {
    ...
    let c: Command = Command::from_atom(&atom).unwrap();
...
fn enum_unknown_variant() {
    ...
    let err = Shape::from_atom(&atom).unwrap_err();
